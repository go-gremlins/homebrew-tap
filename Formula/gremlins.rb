...
class Gremlins < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/go-gremlins/gremlins/releases/download/v0.1.0/gremlins_0.1.0_darwin_arm64.tar.gz"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/go-gremlins/gremlins/releases/download/v0.1.0/gremlins_0.1.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/go-gremlins/gremlins/releases/download/v0.1.0/gremlins_0.1.0_linux_amd64.tar.gz"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/go-gremlins/gremlins/releases/download/v0.1.0/gremlins_0.1.0_linux_arm64.tar.gz"
